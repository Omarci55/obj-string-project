...
- [x] 1. Write a JavaScript function to truncate a string to a certain number of words.

```js
console.log(truncate("The quick brown fox jumps over the lazy dog", 4)); // "The quick brown fox"
```

- [x] 2. Write a JavaScript function to alphabetize a given string.
...
- [x] 3. Write a JavaScript function to convert ASCII to Hexadecimal format.
...
- [x] 4. Write a JavaScript function to get humanized number with the correct suffix such as 1st, 2nd, 3rd or 4th.r
...
- [x] 6. Write a JavaScript function to sort the following array of objects by title value.
...
- [x] 9. Write a JavaScript function to print all the methods in an JavaScript object.
...
- [x] 10. Write a JavaScript function to print all the properties in an JavaScript object.
